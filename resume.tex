...
\section{Programming Skills}
  ...
  \begin{description}
    ...
    \item[Languages:]{C, C++, C\#, Java, Python, Javascript, SQL, .NET Framework, .NET Core}
    \item[Database Technologies:]{MySQL, PostgreSQL, NoSQL, MongoDB, Oracle}
    \item[Continous Integration/Deployment Technologies:]{CircleCI, Jenkins, Atlassian} 
    \item[Cloud Technologies:]{Amazon Web Services (AWS), Microsoft Azure, Docker, Kubernetes}
    \item[Javascript Frameworks:]{Angular, React, TypeScript}
  \end{description}
